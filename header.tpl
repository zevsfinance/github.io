...
<head>
    ...
    <link rel="icon" href="favicon.ico" type="image/x-icon.ico">
...
font-size:30px;
            ...
            <div class="lkPage">
                ...
                <div class="lkContent">
                    <div class="lkMenu">
                        <ul>
                            <li><a href="{"?a=account"|encurl}"{if $smarty.get.a=='account'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/client-management.png"/>  </span>MY Account</a></li>
                            <li><a href="{"?a=deposit"|encurl}"{if $smarty.get.a=='deposit'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/initiate-money-transfer.png"/>   </span>Make deposit</a></li>
                       <li><a href="{"?a=deposit list"|encurl}"{if $smarty.get.a=='deposit list'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/riefcase.png"/>   </span>deposits</a></li>
                            <li><a href="{"?a=withdraw"|encurl}"{if $smarty.get.a=='withdraw'} class="active"{/if}><img src="https://img.icons8.com/color/48/000000/request-money.png"/>   </span>withdrawal</a></li>
               <li><a href="{"?a=edit_account"|encurl}"{if $smarty.get.a=='edit_account'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/job--v1.png"/>    </span>settings</a></li>
                            <li><a href="{"?a=security"|encurl}"{if $smarty.get.a=='security'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/privacy.png"/> 
                              </span>security</a></li>                        
                            <li><a href="{"?a=earnings"|encurl}"{if $smarty.get.a=='earnings'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/overtime.png"/>   </span>history</a></li>                                          <li><a href="{"?a=referals"|encurl}"{if $smarty.get.a=='referals'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/commercial-development-management.png"/></span>referrals</a></li>
                            <li><a href="{"?a=referallinks"|encurl}"{if $smarty.get.a=='referallinks'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/change.png"/>  </span>ADreting link</a></li>
                            <li><a href="{"?a=tell_friend"|encurl}"{if $smarty.get.a=='tell_friend'} class="active"{/if}><img src="https://img.icons8.com/color/42/000000/commercial.png"/>   </span>Tell friend</a></li>
                            <li><a href="{"?a=logout"|encurl}"><img src="https://img.icons8.com/color/42/000000/door-sensor-alarmed.png"/>   </span>LOGOUT</a></li>
                        </ul>
                    </div>
